...
//            holder.binding.serviceDesc.text = recipe.ServicePlan_c
                if (recipe.AppointmentDate != null) {
                    holder.binding.tvPlanDate.text =
                        AppUtils2.formatDateTime4(recipe.AppointmentDate.toString())
                } else {
                    holder.binding.tvPlanDate.text =
                        AppUtils2.formatDateTime4(recipe.SRDate_c.toString())
...
//        }
                holder.itemView.setOnClickListener {
                    onResceduleInterface!!.onRecheduleClick(
                        position,
                        upcomingservicelist as ArrayList<UpcomingService>
                    )
...
//        }
                ...
                holder.binding.tvPayNow.setOnClickListener {
                    onResceduleInterface!!.onPaymentClick(
                        position,
                        codOrders as ArrayList<CODOrders>
                    )
                }

                holder.itemView.setOnClickListener {
                    onResceduleInterface!!.onPaymentitemsClick(
                        position,
                        codOrders as ArrayList<CODOrders>
                    )
                }
...
//            }
    ...
    class MainViewHolder(val binding: LayoutPaymentDashboardAdapterBinding) :
