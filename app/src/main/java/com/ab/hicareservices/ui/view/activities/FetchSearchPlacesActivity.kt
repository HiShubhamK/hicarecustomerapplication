...
import com.ab.hicareservices.databinding.ActivityFetchPlacesBinding
...
class FetchSearchPlacesActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_fetch_places)
        try {
...
//            }
            ...
            val placeAutocompleteAdapter =
                PlaceAutocompleteAdaptere(this, placesClient, autocompleteSessionToken)
...
//            val defaultPosition = LatLng(Latt.toDouble(), Longg.toDouble())
//            marker = mMap?.addMarker(MarkerOptions().position(defaultPosition).draggable(false))!!
...
class PlaceAutocompleteAdaptere(
    context: Context,
