...
class BookingSlotComplinceActivity : AppCompatActivity() {

    private lateinit var binding: ActivityBookingSlotComplinceBinding
    private val viewModel: GetSlotViewModel by viewModels()
    private lateinit var mAdapter: BookingSlotCompliceAdapater
    private var mobile = ""
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_booking_slot_complince)
        binding = ActivityBookingSlotComplinceBinding.inflate(layoutInflater)
...
//            LinearLayoutManager(activity, LinearLayoutManager.VERTICAL, false)
        mAdapter = BookingSlotCompliceAdapater()
