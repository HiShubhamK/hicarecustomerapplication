...
data class Account(
    ...
    @SerializedName("Account_Lat__c") val account_Lat__c : Double?,
    @SerializedName("Account_Long__c") val account_Long__c : Double?,
    @SerializedName("Location__Latitude__s") val location__Latitude__s : Double?,
    @SerializedName("Location__Longitude__s") val location__Longitude__s : Double?,
    ...
    @SerializedName("Locality_Pincode__r") val locality_Pincode__r : Locality?,
