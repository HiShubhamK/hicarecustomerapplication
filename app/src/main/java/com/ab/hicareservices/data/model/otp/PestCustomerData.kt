...
import com.ab.hicareservices.data.model.dashboard.LocalityPincode_r
import com.google.gson.annotations.SerializedName

data class PestCustomerData(
    ...
    @SerializedName("Sub_Type__r") var SubType_r: SubType_r? = SubType_r(),
    @SerializedName("Flat_Type__r") var FlatType_r: FlatType_r? = FlatType_r(),
    @SerializedName("Account_Types__r") var AccountTypes_r: AccountTypes_r? = AccountTypes_r(),
    @SerializedName("Locality_Pincode__r") var LocalityPincode_r: LocalityPincode_r? = LocalityPincode_r(),
    @SerializedName("Customer_Type__r") var CustomerType_r: CustomerType_r? = CustomerType_r()
